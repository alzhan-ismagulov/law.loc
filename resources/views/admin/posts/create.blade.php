...
<div class="nova-card-table" style="min-width: 600px; margin: 0 auto; padding: 30px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <div style="font-size: 16px; margin-bottom: 0; font-weight: 600; font-family: 'Inter', sans-serif;">Добавление поста</div>
    ...
    <div class="nova-card-table" style="padding: 25px; box-shadow: none; border: 1px solid #e2e8f0; border-radius: 6px; background: #ffffff;">
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="slug" class="nova-input" value="{{ old('slug') }}" placeholder="post-slug" style="width: 100%; box-sizing: border-box;">
            </div>

            <div style="margin-bottom: 25px;">
                <label style="display: block; margin-bottom: 8px; color: #64748b; font-size: 14px;">Описание</label>
                <textarea name="description" class="nova-input" placeholder="Описание поста..." style="width: 100%; height: 100px; resize: vertical; box-sizing: border-box;">{{ old('description') }}</textarea>
            </div>
            ...
            <div style="margin-bottom: 25px;">
                <label style="display: block; margin-bottom: 8px; color: #64748b; font-size: 14px;">Теги</label>
            ...
            <!-- Текст поста с ID для CKEditor -->
            <div style="margin-bottom: 25px;">
                <label style="display: block; margin-bottom: 8px; color: #64748b; font-size: 14px;">Текст поста</label>
                <textarea name="content" id="editor" class="nova-input" placeholder="Текст поста..." style="width: 100%; height: 500px; box-sizing: border-box;">{{ old('content') }}</textarea>
            </div>
            ...
            <div style="display: flex; justify-content: flex-end;">
                <button type="submit" class="nova-input" style="background-color: #3b82f6; color: #ffffff; cursor: pointer; width: auto; padding: 10px 24px; border: none; border-radius: 4px; font-size: 14px;">Создать пост</button>
            </div>
        </form>
    </div>
