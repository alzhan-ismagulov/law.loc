...
<div class="nova-card-table" style="min-width: 600px; margin: 0 auto; padding: 30px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <div style="font-size: 16px; margin-bottom: 0; font-weight: 600; font-family: 'Inter', sans-serif;">Добавление тега</div>
    ...
    <div class="nova-card-table" style="padding: 25px; box-shadow: none; border: 1px solid #e2e8f0; border-radius: 6px; background: #ffffff;">
        <form action="{{ route('admin.tags.store') }}" method="POST">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="slug" class="nova-input" value="{{ old('slug') }}" placeholder="tag-slug" style="width: 100%; box-sizing: border-box;">
            </div>
