...
<div class="nova-card-table" style="margin: 0 auto; padding: 30px; max-width: 600px;">
    <div class="table-header" style="margin-bottom: 20px;">Добавить язык</div>
    ...
    <form action="{{ route('admin.languages.store') }}" method="POST">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="title" value="{{ old('title') }}" class="nova-input" style="width: 100%;" required>
        </div>
        ...
        <div style="display: flex; justify-content: flex-end; gap: 10px;">
            ...
            <button type="submit" class="nova-input" style="background-color: #3b82f6; color: #ffffff; cursor: pointer; padding: 8px 16px; border: none;">Сохранить</button>
        </div>
    </form>
</div>
@endsection